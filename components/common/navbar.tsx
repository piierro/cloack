    ...
    return (
        <NavigationMenu className={`${styles.NavCont} dark:bg-slate-800 bg-slate-300 pt-5 pb-5 flex row flex-wrap gap-2 align-center justify-between p-10`}>
                ...
                {data.map(elem => {
                        return (
                            ...
                            <NavigationMenuLink asChild>
                              <a
                                className={`${styles.NanLink} flex select h-full w-full flex-col justify-end p-2.5 rounded-lg ${pathname === elem.href && 'bg-card'}`}
                                href={elem.href}
                              >
                                {elem.title}
                              </a>
            ...
            <NavigationMenuItem>
                      ...
                      <NavigationMenuLink asChild>
                      <a
                                className={` ${styles.BtnNav} flex rounded-lg border select h-full w-full align-center items-center justify-center pb-2 gap-1 cursor-pointer pt-1 pb-1 pl-5 pr-5 hover:bg-secondary/80`}
