...
(
    ...
    return (
        <div className="flex items-center gap-2 mb-5 container">
                            ...
                            />
                            <div className={`${styles.TabBlock} campaign-info container flex flex-wrap items-center gap-2 justify-between p-2 pl-5 pr-5 rounded-lg bg-card`}>
                                <div className="name flex flex-col items-start gap-1">
                                    <span className="md:hidden gray-text">Name</span>
                                    {item.name}
                                </div>
                                <div className="other-info flex  items-center flex-wrap justify-between gap-12">
                                    <div className="flex  items-center gap-10">
                                        ...
                                        <span className="md:hidden gray-text">Status</span>
                                            <Button className="w-[100%] min-w-[100px]" variant={item.status >= 1 ? 'success' : 'customDestructive'}>
                                                {item.status >= 1 ? "Active" : "Deactivated"}
                                            </Button>
                                        </div>
                                    </div>
                                    <div className="last-updated-passed flex items-center justify-center gap-10">
